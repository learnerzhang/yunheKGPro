# Generated by Django 3.2.18 on 2025-03-11 02:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('kg_doc_ids', models.ManyToManyField(blank=True, to='kgapp.KgDoc', verbose_name='文档关联')),
                ('kg_user_id', models.ForeignKey(blank=True, help_text='创建作者', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建作者')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('kg_business_id', models.ForeignKey(blank=True, help_text='业务名称', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.kgbusiness', verbose_name='业务名称')),
                ('kg_temp_content_id', models.ForeignKey(blank=True, help_text='所属目录', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.kgtemptablecontent', verbose_name='所属目录')),
                ('kg_user_id', models.ForeignKey(blank=True, help_text='创建作者', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='创建作者')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('kg_prod_task_id', models.ForeignKey(blank=True, help_text='关联任务', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.kgproducttask', verbose_name='关联任务')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('tags', models.ManyToManyField(blank=True, to='kgapp.KgTag', verbose_name='关联标签')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('task', models.ForeignKey(blank=True, help_text='关联任务', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.kgproducttask', verbose_name='关联任务')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('attrs', models.ManyToManyField(blank=True, to='kgapp.KgEntityAttrScheme', verbose_name='属性列表')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('atts', models.ManyToManyField(blank=True, to='kgapp.KgEntityAtt', verbose_name='属性列表')),
                ('tags', models.ManyToManyField(blank=True, to='kgapp.KgTag', verbose_name='实体标签')),
                ('task', models.ForeignKey(blank=True, help_text='关联任务', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.kgproducttask', verbose_name='关联任务')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('kg_doc_id', models.ForeignKey(blank=True, help_text='关联文档', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.kgdoc', verbose_name='关联文档')),
                ('kg_knowledge_id', models.ForeignKey(blank=True, help_text='所属知识库', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.knowledge', verbose_name='所属知识库')),
                ('tags', models.ManyToManyField(blank=True, to='kgapp.KgDocCttTag', verbose_name='分片关键词')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='kgdoc',
            name='kg_knowledge_id',
            field=models.ForeignKey(blank=True, help_text='知识库', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.knowledge', verbose_name='知识库'),
        ),
        migrations.AddField(
            model_name='kgdoc',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('attrs', models.ManyToManyField(blank=True, to='kgapp.KgDDRuleAttribute', verbose_name='关联指标')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(null=True, verbose_name='创建时间')),
                ('business', models.ForeignKey(blank=True, help_text='业务', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.business', verbose_name='业务')),
