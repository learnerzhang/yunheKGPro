...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='kgdocfragmentation',
            name='kg_doc_id',
            field=models.ForeignKey(blank=True, help_text='关联文档', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.kgdoc', verbose_name='关联文档'),
        ),
        migrations.AddField(
            model_name='kgdocfragmentation',
            name='kg_knowledge_id',
            field=models.ForeignKey(blank=True, help_text='所属知识库', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.knowledge', verbose_name='所属知识库'),
        ),
        migrations.AddField(
            model_name='kgdocfragmentation',
            name='tags',
            field=models.ManyToManyField(blank=True, to='kgapp.KgDocCttTag', verbose_name='分片关键词'),
        ),
        migrations.AddField(
            model_name='kgdoc',
            name='kg_knowledge_id',
        ...
        migrations.AddField(
            model_name='displayquestion',
            name='category',
            field=models.ForeignKey(help_text='分类', null=True, on_delete=django.db.models.deletion.CASCADE, to='kgapp.questioncategory', verbose_name='分类'),
        ),
    ]
