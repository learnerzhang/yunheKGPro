...
urlpatterns = [
    ...
    path('kgdoc/', views.KgDocList.as_view()),
    ...
    path('kgtabtag/', views.KgTabTagList.as_view()),
    ...
    path('kgtag/', views.KgTagList.as_view()),
    ...
    path('kgctt/', views.KgTabCTTList.as_view()),
    ...
    path('kgtbus/', bus_views.KgBusList.as_view()),
    ...
    path('kgtemp/', bus_views.KgTempList.as_view()),
    ...
    path('kgtempctt/', bus_views.KgTabCTTList.as_view()),
    ...
    path('task/', task_views.KgProdTaskList.as_view()),
    ...
    path('tmpqa/', task_views.KgTmpQAList.as_view()),
    path('tmpsimqa/', task_views.KgTmpSimQAList.as_view()),
    path('tmpgraph/', task_views.KgTmpGraphList.as_view()),
    path('tmpsimgraph/', task_views.KgTmpSimGraphList.as_view()),
    path('tmpfullprod/', task_views.kgFullProdList.as_view()),
    path('prodqalist/', man_views.KgQAList.as_view()),
    ...
    path('graphEntityScheme/', graph_views.KgEntitySchemeList.as_view()),
    ...
    path('graphRelationScheme/', graph_views.KgRelationSchemeList.as_view()),
