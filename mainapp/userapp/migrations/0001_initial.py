    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(default=datetime.datetime(2025, 3, 31, 17, 29, 44, 121412), null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(default=datetime.datetime(2025, 3, 31, 17, 29, 44, 121412), null=True, verbose_name='创建时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(default=datetime.datetime(2025, 3, 31, 17, 29, 44, 122412), null=True, verbose_name='更新时间')),
                ('created_at', models.DateTimeField(default=datetime.datetime(2025, 3, 31, 17, 29, 44, 122412), null=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', related_name='new_user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
