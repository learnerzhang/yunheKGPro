...
class PlanFactory:
    ...
    def get_ysgxq_api(self):
        if self.context['type'] == 4:
            ...
            hdsq_table_name = self.params['hdsq_table_name'] if "hdsq_table_name" in self.params else " "
            sksq = self.params['sksq'] if self.params else []
            sksq_table_name = self.params['sksq_table_name'] if "sksq_table_name" in self.params else " "
            zxsksq = self.params['zxsksq'] if 'zxsksq' in self.params else []
