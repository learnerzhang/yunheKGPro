"""
Django settings for mockplatform project.
...
DB_NAME = os.environ.get('DB_NAME', "mock")
...
ROOT_URLCONF = 'mockplatform.urls'
...
WSGI_APPLICATION = 'mockplatform.wsgi.application'
